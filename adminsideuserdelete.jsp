...
<pre><b><input type="checkbox" required>Delete Account </b></pre
							   ...
							   <center>
<a href="view user.jsp"><input type="button" name="cancel" value="Cancel" id="contBtn"  ></a>
<input type="submit" name="delete" value="Delete" id="contBtn"  onclick="con();" >
</center>
